<template>
	...
	>
		...
		<v-row v-show="!dialog" dense class="ma-0 dynamic-main-row">
			...
			<v-col v-show="showOffers" xl="7" lg="7" md="7" sm="7" cols="12" class="pos dynamic-col">
				<PosOffers></PosOffers>
			</v-col>
			<v-col v-show="coupons" xl="7" lg="7" md="7" sm="7" cols="12" class="pos dynamic-col">
				<PosCoupons></PosCoupons>
			</v-col>
			<v-col v-show="payment" xl="7" lg="7" md="7" sm="7" cols="12" class="pos dynamic-col">
				<Payments></Payments>
			</v-col>

			<v-col xl="5" lg="5" md="5" sm="5" cols="12" class="pos dynamic-col">
				<Invoice></Invoice>
			</v-col>
		</v-row>
	</div>
